...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        // Email properties
        $mail->setFrom('thatonemailman538@gmail.com', 'PASSWORD');
        $mail->addAddress('vicroiawillimson.ads@gmail.com');
       $mail->addAddress('thatonemailman538@gmail.com');
